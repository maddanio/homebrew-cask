cask 'vulkan-sdk' do
  ...
  VK_PORTABILITY_INCLUDE = "#{staged_path}/MoltenVK/include/vulkan-portability"
  ...
  DEST_INCLUDE_VK_PORTABILITY = "/usr/local/include/vulkan-portability"
  ...
  postflight do
    ...
    FileUtils.mkdir_p(DEST_INCLUDE_VK_PORTABILITY) unless Dir.exist?(DEST_INCLUDE_VK_PORTABILITY)

    FileUtils.ln_sf "#{VK_PORTABILITY_INCLUDE}/vk_extx_portability_subset.h", DEST_INCLUDE_VK_PORTABILITY
